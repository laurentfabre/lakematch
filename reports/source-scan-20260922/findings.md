...
- **target**: `/var/folders/m4/qxnnrm4s5q5f_p71yp5qdzmc0000gp/T/lakematch-source-scan-1onlo_cp`
...
| `BP-101` | warn | Implement idempotent pipelines: re-running should not duplicate data. | 4 |
...
| `BP-234` | info | Use NOT NULL constraints on critical columns. | 2 |
| `BP-171` | info | Add clear, business-friendly descriptions to every table and column exposed to Genie. | 2 |
| `BP-022` | info | Add comments/descriptions to all tables, columns, and schemas for discoverability. | 2 |
...
| `BP-101` | `src/lakematch/mastering/registry.py:68` | file_grep matched pattern_any | Plain INSERT INTO without MERGE or INSERT OVERWRITE — non-idempotent under retry |
