...
- **target**: `/var/folders/m4/qxnnrm4s5q5f_p71yp5qdzmc0000gp/T/lakematch-source-scan-e5eeytzu`
...
| `BP-234` | info | Use NOT NULL constraints on critical columns. | 4 |
| `BP-171` | info | Add clear, business-friendly descriptions to every table and column exposed to Genie. | 4 |
| `BP-022` | info | Add comments/descriptions to all tables, columns, and schemas for discoverability. | 4 |
...
| `BP-227` | info | Use CHECK constraints for basic data validation at the table level. | 3 |
