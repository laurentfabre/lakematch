...
Created: 2026-09-19. Status: in progress; ZR-3 classifier and compact-feature comparisons completed; linkage iteration 4 hit a query-plan heap failure and iteration 5 adds owned table boundaries. ZR-4 native comparisons and incremental identity iteration 6 passed on both corpora; durable CLI publication is under verification. ZR-1/2/5 passed at commit 6f859f4; affected acceptance evidence needs refresh after candidate integration. Classic compute is confirmed unsupported on the selected workspace; ZR-9 parked at ENV.
